...
import WBAvatar from '../assets/avatar.png';
    ...
    return (
      <Navbar expand="lg">
        <div className="container">
          <Navbar.Brand href="#1">
            <img height="40" src={WBLogo} alt="WeatherBuds Logo" />
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="navbarSupportedContent">
            ...
            <Nav className="align-items-center">
              ...
              <NavDropdown title={<img height="40" src={WBAvatar} alt="User Avatar" />} id="basic-nav-dropdown">
